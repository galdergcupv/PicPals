...
public class ViewSharedPhotosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_shared_photos);
    ...
    private void processResultAndUpdateAdapter(String result) {
        if (result != null) {
            if (result.equals("\"No se encontraron imagenes compartidas para este usuario\"")) {
                Toast.makeText(this, "No se encontraron imagenes compartidas para este usuario", Toast.LENGTH_SHORT).show();
                finish();
                return;
            }
            try {
            ...
            Log.e("ViewSharedPhotos", "Result is null");
        }
    }
}
